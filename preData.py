...
if __name__ == "__main__":
    ...
    PATH = 'H:/My Drive/rawData/MDC_HZDR/simulation_20220715/'
    ...
    parser.add_argument('--threshold', default=0.825, help='threshold the normalized masks')
    ...
    if not os.path.isdir('./preData_3channels'):
        os.mkdir('./preData_3channels')
        
    SAVED_PATH = 'E:/EM/demo/3D_Unet_keras/preData_3channels/'
        
    img_list = sorted(glob.glob(args.img_dir + '/*focal.mrc'))
    msk_list = sorted(glob.glob(args.mask_dir + '/*gt.mrc'))
    ...
    for num in range(num_images):
        ...
        # binary the mask
        temp_msk = (temp_msk < args.threshold).astype(int)
        ...
        temp_img = np.stack([temp_img, temp_img, temp_img], axis = 3)
    ...
    OUTPUT_PATH = 'E:/EM/demo/3D_Unet_keras/inputData_3channels/'
